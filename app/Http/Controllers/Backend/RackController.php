...
class RackController extends Controller
{
    ...
    {
        $this->middleware('permission:read-rack|create-rack|edit-rack|delete-rack', ['only' => ['index', 'apiBlodgroup']]);
        $this->middleware('permission:create-rack', ['only' => ['create']]);
        $this->middleware('permission:edit-rack', ['only' => ['edit', 'update']]);
        $this->middleware('permission:delete-rack', ['only' => ['destroy']]);
    }

    public function apiRack()
    {

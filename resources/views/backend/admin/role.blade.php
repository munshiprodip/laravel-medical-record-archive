    ...
    <div class="col-12">
        ...
        <div class="card card-primary">
            <div class="card-header">
                ...
                <h3 class="card-title"><span><button onclick="addRole()" class="btn btn-light">ADD NEW</button></span></h3>
...
@section('script')
    <script type="text/javascript">
        ...
        $(function () {
            $('#addRole form').on('submit', function (e) {
        ...
        $(function () {
            $('#editRole form').on('submit', function (e) {
                if (!e.isDefaultPrevented()){
                    var id = $('#id').val();
                    $.ajax({
                        url: "{{url('role')}}"+'/'+id,
                        type: "POST",
                        data: $('#editRole form').serialize(),
                        success:function (data) {
                            const Toast = Swal.mixin({
                                toast: true,
                                position: 'top-end',

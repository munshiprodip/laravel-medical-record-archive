    ...
    <div class="col-12">
        ...
        <div class="card card-primary">
            <div class="card-header">
                ...
                <h3 class="card-title"><span><button onclick="addData()" class="btn btn-light">ADD NEW</button></span></h3>

    ...
    <div class="col-12">
        ...
        <div class="card card-dark">
            <div class="card-header">
                ...
                <h3 class="card-title"><span><a href="{{route('files.create')}}" class="btn btn-outline-info">ADD NEW</button></a></span> PATIENT'S FILE LIST</h3>
                    ...
                    <tbody>
                        @foreach($files as $row)
                            <tr class="{{$row->active_status===0? 'bg-warning':""}}">
                                ...
                                <td>{{$row->is_dead===0?'No':'Yes'}}</td>
                                <td>{{$row->active_status===1?'In Archive':'Issued to another'}}</td>
                                <td>
                                    <div class="btn-group">

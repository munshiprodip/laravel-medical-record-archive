...
@section('title', 'LOCKER LIST')

@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
    <li class="breadcrumb-item"><a href="#">Archive Setting</a></li>
    <li class="breadcrumb-item active">Locker</li>
@endsection
            ...
            <div class="modal-content">
                <form method="POST" >
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <input type="number" name="capacity" class="form-control" required placeholder="Capacity" >
